...
// Copied on 2025-03-16 from https://stackoverflow.com/a/49743348/10305364 by njuffa
...
float percentile_to_z (float percentile)
{
    if (percentile == 50) return 0.0f;
    int sign = (percentile > 50) ? 1 : -1;
    return sign * SQRT2 * erfinvf(fabs(percentile / 50.0f - 1));
}
